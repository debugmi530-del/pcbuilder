    ...
    switch (widget.category) {
      case ComponentCategory.cpu:
        return [
          ...
          'Частота памяти JEDEC',
          'Частота памяти в разгоне',
          // Тепловыделение
      ...
      case ComponentCategory.gpu:
        return [
          _brandKey,
          // Графический процессор (чип) — как на DNS
      ...
      case ComponentCategory.motherboard:
        return [
          ...
          'Звуковая схема',
          // Задняя панель
          'USB на задней панели (Type-C)',
          'USB на задней панели (Type-A)',
          // Вентиляторы и разъёмы
          'Разъёмы вентиляторов',
          'Разъёмы ARGB',
          'Разъёмы RGB',
